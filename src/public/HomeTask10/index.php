...
<form action="Server.php" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="form-input">
            ...
            <input required type="text" id="name" name="name" value="Ivan">
        </div>

        <div class="form-input">
            <label for="surname">Input your surname</label>
            <input required type="text" id="surname" name="surname" value="Ivanov">
        </div>

        <div class="form-input">
            <label for="age">Input your age</label>
            <input required type="text" id="age" name="age" value="33">
        </div>
        ...
        <div class="form-input">
            <label for="photo">Upload add files</label>
            <input type="file" id="multiphoto" name="multiphoto[]" multiple accept="image/jpeg">
        </div>
    ...
    <fieldset>
        ...
        <div class="form-input">
            ...
            <input required type="text" id="profession" name="profession" value="IT">
        </div>
        <div>

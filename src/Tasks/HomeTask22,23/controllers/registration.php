...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    header('Location: http://localhost:8000/src/Tasks/HomeTask22,23/registration.php');
    exit;
}
...
if (!$userId) {
    echo "error";
    header('Location: http://localhost:8000/src/Tasks/HomeTask22,23/controllers/login.php');
    return;
}
setRegisterInform();
saveUserSession($userId, $userLogInfo);
header('Location: http://localhost:8000/src/Tasks/HomeTask22,23/cabinet.php');
